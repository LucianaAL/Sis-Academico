  ...
  <div id="page-inner">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <span><h4> Cadastrar Profissional</h4></span>
      </div>
    </div>
    <!-- /. ROW  -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          {!! Form::open(['action' => 'Painel\ProfissionalController@store']) !!}
            ...
            <div class="form-group col-md-6">
              {!! Form::label('profissional_disciplina','Disciplina') !!}
              {!! Form::number('profissional_disciplina', null, ['placeholder' => 'Disciplina', 'class' => 'form-control']) !!}
            </div>
        </div>
        <div class="panel-body">
            <div id="page-inner">
